            ...
            try:
                ...
                while True:
                    ...
                    try:
                        ...
                        # Sleep for 1 minute before sending the next email
                        time.sleep(5)
                ...
                # Sleep for 1 minute before starting with the next SMTP server
                time.sleep(5)
...
def load_config():
	...
	threads_count = 1 if len(smtp_pool_array) * 5 > 1 else len(smtp_pool_array) * 5
